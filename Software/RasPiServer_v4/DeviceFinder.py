...
class SerialDeviceFinder(DeviceFinder):
    ...
    def find_devices(self):
        ...
        _device_ids = self._current_devices.keys()
        ...
        proc = subprocess.Popen('/home/pi/RasPiServer_v4/usb.sh',
...
class FTDIDeviceFinder(DeviceFinder):
    ...
    def __init__(self, identifiers):
        ...
        for name, info in self._identifiers.iteritems():
            try:
    ...
    def find_devices(self):
        ...
        for cfg in dev:
            ...
            idf = None
            for name, vp in self._vend_prod_list.iteritems():
                if vend_prod == vp:
                    idf = name
                    break
