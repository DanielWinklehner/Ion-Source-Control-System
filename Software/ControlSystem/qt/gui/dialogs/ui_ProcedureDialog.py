...
class Ui_ProcedureDialog(object):
    def setupUi(self, ProcedureDialog):
        ...
        ProcedureDialog.resize(743, 735)
        font = QtGui.QFont()
        ...
        self.vboxAction.addWidget(self.label_7)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 697, 296))
    ...
    def retranslateUi(self, ProcedureDialog):
        ...
        self.label_6.setText(_translate("ProcedureDialog", "<html><head/><body><p>[Device].[Channel] is [&gt;|&lt;|=] to [Value]</p></body></html>"))
        self.groupBox_3.setTitle(_translate("ProcedureDialog", "Action"))
        self.label_7.setText(_translate("ProcedureDialog", "<html><head/><body><p>Set [Device].[Channel] to [Value]</p></body></html>"))
