...
class Device:
	...
	def add_device_to_gui(self):
		...
		if self._on_overview_page:
			...
			# Create a frame
			self._overview_frame = MIST1ControlSystemGUIWidgets.FrontPageDeviceFrame(label=self._label)
	...
	def initialize(self):
		...
		# infobar = MIST1ControlSystemGUIWidgets.FrontPageDisplayValue(name="{} at Port: {}. Polling rate =".format(self._label, self._serial_com.arduino_port()), displayformat=".1f", unit="Hz")
		infobar = MIST1ControlSystemGUIWidgets.FrontPageDisplayValue(name="{}. Polling rate =".format(self._label), displayformat=".1f", unit="Hz")
