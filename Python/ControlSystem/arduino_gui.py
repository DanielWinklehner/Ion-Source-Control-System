...
interlock_others_arduino_id = "9de3d90f-cdf7-4ef8-9604-548243401df6"
...
class Handler:
    ...
    def initialize_devices(self, force=False):
        """
        Sets up the devices in self._devices
        :return:
        """

        for device in self._devices:
            if not device.initialized or force:
                device.initialize()
    ...
    def read_and_identify_devices(self):
        ...
        for port_name in self._device_addresses:
            ...
            if self._device_addresses[port_name] == interlock_others_arduino_id:
                ...
                for i in range(1, 2):
                    interlock_others_channels['flow_meter_' + str(i)] = Channel(name="flow_meter_" + str(i),
                                                                                serial_com=interlock_others_serial_com,
                ...
                # Reed Switches. x 2
                for i in range(1, 2):
                    interlock_others_channels['micro_switch_' + str(i)] = Channel(name="micro_switch_" + str(i),
                                                                                  serial_com=interlock_others_serial_com,
                                                                                  message_header="micro_switch_" + str(
...
if __name__ == "__main__":
    ...
    dev1 = hand.add_device()
    dev1.add_channel()

    hand.initialize_devices(force=True)
