...
class MIST1ControlSystem:
    ...
    def get_channel_values(self, device):
        ...
        precisions = [5] * len(channel_names)                   # For sensor box, precision = 5 needs messages longer than 128 bytes.
                            ...
                            if channel.mode() == "read" or channel.mode() == "both":
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        # self.update_all_plots(device.name())
    ...
    def update_all_plots(self, device_name):
        print "updating all plots for device = ", device_name
