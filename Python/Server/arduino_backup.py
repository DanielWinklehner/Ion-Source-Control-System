...
# [["95433343933351B012C2", "/dev/ttyACM0"], ["95432313837351706152", "/dev/ttyACM1"]]


m_1 = Manager()
s_1 = m_1.SerialCOM(arduino_id="95433343933351B012C2", port_name="/dev/ttyACM0")

m_2 = Manager()
s_2 = m_2.SerialCOM(arduino_id="95432313837351706152", port_name="/dev/ttyACM1")

print s_1.send_message("c")
print s_2.send_message("c")
